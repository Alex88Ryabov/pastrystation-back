export function define(categories: string, param2: {imageName: {type: StringDataTypeConstructor}; imageFile: {type: TextDataTypeConstructor}; name: {type: StringDataTypeConstructor}; id: {autoIncrement: boolean; allowNull: boolean; type: IntegerDataTypeConstructor; primaryKey: boolean}}, param3: {timestamps: boolean}) {
